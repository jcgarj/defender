...
use DsCorp\Equipo\EquipoBundle\Entity\producto;
use DsCorp\Equipo\EquipoBundle\Form\productoType;
...
class productoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EquipoBundle:producto')->findAll();

        return $this->render('EquipoBundle:producto:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EquipoBundle:producto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EquipoBundle:producto')->find($id);
        ...
        return $this->render('EquipoBundle:producto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EquipoBundle:producto:edit.html.twig', array(
            'entity'      => $entity,
