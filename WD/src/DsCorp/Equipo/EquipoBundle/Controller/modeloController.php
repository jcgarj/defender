...
use DsCorp\Equipo\EquipoBundle\Entity\modelo;
use DsCorp\Equipo\EquipoBundle\Form\modeloType;
...
class modeloController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EquipoBundle:modelo')->findAll();

        return $this->render('EquipoBundle:modelo:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EquipoBundle:modelo:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EquipoBundle:modelo')->find($id);
        ...
        return $this->render('EquipoBundle:modelo:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EquipoBundle:modelo:edit.html.twig', array(
            'entity'      => $entity,
